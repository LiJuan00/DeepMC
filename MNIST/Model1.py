...
def Model1(input_tensor=None, train=False):
    ...
    if train:
        ...
        # the data, shuffled and split between train and test sets 数据，在训练集和测试集之间打乱和分割
    ...
    if train:
        ...
        # trainig
        model.fit(x_train[:30000], y_train[:30000], validation_data=(x_test, y_test), batch_size=batch_size, epochs=nb_epoch, verbose=1)
        # save model
